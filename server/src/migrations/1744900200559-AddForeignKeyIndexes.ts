...
export class AddForeignKeyIndexes1744900200559 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_02a43fd0b3c50fb6d7f0cb7282" ON "asset_faces" ("assetId")`);
    await queryRunner.query(`CREATE INDEX "IDX_95ad7106dd7b484275443f580f" ON "asset_faces" ("personId")`);
    await queryRunner.query(`CREATE INDEX "IDX_575842846f0c28fa5da46c99b1" ON "memories" ("ownerId")`);
    await queryRunner.query(`CREATE INDEX "IDX_7e077a8b70b3530138610ff5e0" ON "partners" ("sharedById")`);
    ...
    await queryRunner.query(`CREATE INDEX "IDX_6afb43681a21cf7815932bc38a" ON "user_metadata" ("userId")`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_66fe3837414c5a9f1c33ca4934";`);
    await queryRunner.query(`DROP INDEX "IDX_6afb43681a21cf7815932bc38a";`);
    ...
    await queryRunner.query(`DROP INDEX "IDX_02a43fd0b3c50fb6d7f0cb7282";`);
    await queryRunner.query(`DROP INDEX "IDX_95ad7106dd7b484275443f580f";`);
    ...
    await queryRunner.query(`DROP INDEX "IDX_92e67dc508c705dd66c9461557";`);
    ...
    await queryRunner.query(`DROP INDEX "IDX_7e077a8b70b3530138610ff5e0";`);
